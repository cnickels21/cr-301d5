...
// You cannot use arrow functions to create constructors because they have nothing connecting them to the specific values of each individual new object.
...
//    "this" is undefined because there is no value to be returned.  The scope prototype tied to the constructor runs, but has no return value to output.
// 2. What is "this" when joe.scopeArrow() is invoked?
//    "this" is referring to the window itself because arrow functions cannot have a "this" tied to them therefore "this" bubbles up to the next object it can refer to.
// 3. Explain why "this" is different when an arrow function is used.
//    Because arrow functions cannot have "this" tied to them "this" when declared in the prototype links to the only object it can find, but when the prototype is actually declared there is nothing for "this" to tie to.  When "this" is used in a regular function it ties only to that individual object when it is invoked.
