...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT:  'rando' comes back undefined because it is defined within the displayPics() function. The console.log calls that variable outside of the function, but if console.log() had been inside of the function it would have returned properly.
  console.log(viewed);
